...
const CourseCard = ({ course }) => {
	return (
		<div className="w-[296px] rounded-[14px] bg-white shadow-[0_4px_25px_0_rgba(0,0,0,0.10)] flex-shrink-0">
			...
			/>
			{/* couse details */}
			<div className="w-full px-[16px] pt-[18.25px] pb-[19px] flex flex-col justify-start items-start gap-[30px]">
