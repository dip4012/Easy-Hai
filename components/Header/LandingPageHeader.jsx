...
const LandingPageHeader = () => {
	return (
		<div className="h-[729px] w-full bg-[#8940FF] rounded-b-[50px] px-[105px] py-[43px] relative max-[767px]:px-[20px]">
			...
			<Image
				...
				width={663}
				height={612}
				className="w-[663px] h-[612px] absolute bottom-0 right-[92.19px] z-[1] max-[767px]:bottom-[9px] max-[767px]:right-[50%] max-[767px]:translate-x-[39%]  max-[767px]:w-[586px] max-[767px]:h-[542px]"
			/>
