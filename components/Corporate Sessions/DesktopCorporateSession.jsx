...
const DesktopCorporateSession = () => {
	return (
		<section className="w-full px-[90px] pt-[90px] pb-[124px] bg-white relative z-0">
			{/* section header */}
			...
			<div className="w-full flex justify-center items-center mt-[65px]">
				<div className="p-[40px] flex justify-start items-center gap-[26.63px] overflow-x-scroll no-scrollbar">
